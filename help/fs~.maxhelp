...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 207.0, 211.0, 79.0, 22.0 ],
									"text" : "prepend note"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 207.0, 172.0, 59.0, 22.0 ],
									"text" : "append 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 207.0, 127.0, 92.5, 22.0 ],
									"text" : "midiparse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 207.0, 76.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.5, 608.5, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 836.0, 607.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "bang", "" ],
					"patching_rect" : [ 850.0, 640.5, 80.0, 22.0 ],
					"text" : "seq bach.mid"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 763.0, 640.5, 43.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 46.0, 634.0, 17.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 634.0, 17.0, 39.0 ],
					"scale" : 7.943210124969482
				}
...
, 			{
				"box" : 				{
					...
					"text" : "fs~ [<polyphony (def: 256)> [<# of MIDI channels (def: 16)>]] [<soundfont filename>]"
				}
